			...
			<div class="padding border-bottom">
				<ul class="search">
					<li>
						...
						</button> <input type="text" placeholder="请输入教师名" name="str"
						class="input"
				...
				<c:forEach items="${pageResult.dataList }" var="teacher">
					<tr>
						<td style="text-align: left; padding-left: 20px;"><input
							type="checkbox" name="ids" value="${teacher.tId }" /></td>
						<td>${teacher.tName }</td>
						<td>${teacher.sex }</td>
						<td>${teacher.age }</td>
						...
						<td><div class="button-group">
								...
								<a class="button border-main"
									href="<%=basePath%>teacherController/updateUI.do?tId=${teacher.tId }"><span
									class="icon-edit"></span>修改</a> <a class="button border-red"
									href="<%=basePath%>teacherController/delete.do?tId=${teacher.tId }"
