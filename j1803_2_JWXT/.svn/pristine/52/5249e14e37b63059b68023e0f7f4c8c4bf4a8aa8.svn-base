...
<script>
	$(function(){
		...
		var str4 = "";
		var str5 = "";
	    <c:forEach items="${listForenoonSchedule}" var="forenoon" varStatus="status" >  
	        arrayForenoon.push("${forenoon}");  // 对象，加引号
	        /* console.log(arrayForenoon); */
	        if('${forenoon.timeName}'=='星期一上午'){
	        	str1 += '${forenoon.subjectName} ' + '${forenoon.tName} ' + '${forenoon.placeName}' + '<br>';
	        	$(".forenoon_first").html(str1);
	        }if('${forenoon.timeName}'=='星期二上午'){
	        	str2 += '${forenoon.subjectName} ' + '${forenoon.tName} ' + '${forenoon.placeName}' + '<br>';
	        	$(".forenoon_second").html(str2);
	        }if('${forenoon.timeName}'=='星期三上午'){
	        	str3 += '${forenoon.subjectName} ' + '${forenoon.tName} ' + '${forenoon.placeName}' + '<br>';
	        	$(".forenoon_third").html(str3);
	        }if('${forenoon.timeName}'=='星期四上午'){
	        	str4 += '${forenoon.subjectName} ' + '${forenoon.tName} ' + '${forenoon.placeName}' + '<br>';
	        	$(".forenoon_fourth").html(str4);
	        }if('${forenoon.timeName}'=='星期五上午'){
	        	str5 += '${forenoon.subjectName} ' + '${forenoon.tName} ' + '${forenoon.placeName}' + '<br>';
		...
		var str9 = "";
		var str0 = "";
	    <c:forEach items="${listAfternoonSchedule}" var="afternoon" varStatus="status" >  
	    	arrayAfternoon.push("${afternoon}");  // 对象，加引号
	        /* console.log(arrayAfternoon); */
	        if('${afternoon.timeName}'=='星期一下午'){
	        	str6 += '${afternoon.subjectName} ' + '${afternoon.tName} ' + '${afternoon.placeName}' + '<br>';
	        	$(".afternoon_first").html(str6);
	        }if('${afternoon.timeName}'=='星期二下午'){
	        	str7 += '${afternoon.subjectName} ' + '${afternoon.tName} ' + '${afternoon.placeName}' + '<br>';
	        	$(".afternoon_second").html(str7);
	        }if('${afternoon.timeName}'=='星期三下午'){
	        	str8 += '${afternoon.subjectName} ' + '${afternoon.tName} ' + '${afternoon.placeName}' + '<br>';
	        	$(".afternoon_third").html(str8);
	        }if('${afternoon.timeName}'=='星期四下午'){
	        	str9 += '${afternoon.subjectName} ' + '${afternoon.tName} ' + '${afternoon.placeName}' + '<br>';
	        	$(".afternoon_fourth").html(str9);
	        }if('${afternoon.timeName}'=='星期五下午'){
	        	str0 += '${afternoon.subjectName} ' + '${afternoon.tName} ' + '${afternoon.placeName}' + '<br>';
	...
	function edit(){
		window.location.href="<%=basePath%>scheduleController/scheduleTableEditUI.do";
	}
</script>
<style type="text/css">
	.first{
...
<body>
	<div class="panel admin-panel">
		...
		<div class="body-content" align="center">
			<table border="1px solid gray" width="100%" height="450px;">
				<caption></caption>
				<tr class="first">
					<th width="11%">
						<div class="form-group">
							...
							<div class="field">
								<button class="button bg-main icon-edit" id="btn_edit" onclick="edit()"> 编辑表</button>
							</div>
						</div>			
					</th>
					<th width="11%">星期一</th>
				...
				<tr height="200px" style="text-align: center;vertical-align: middle;">
					<th>上午</th>					
