...
<script type="text/javascript">
        ...
        $(function(){
        	$("#btn1").click(function(){
        		$("#fm").attr("action","<%=basePath%>majorController/search.do");
        		$("#fm").submit();
        	});
        })
</script>
	...
	<form method="post" action="<%=basePath%>majorController/deleteMany.do"
		...
		<div class="panel admin-panel">
			<div class="panel-head">
				<strong class="icon-reorder"> 专业管理</strong>
			</div>
			<div class="padding border-bottom">
				<ul class="search">
					<li>
						...
						type="text" placeholder="请输入专业" name="str" class="input"
				...
				<c:forEach items="${pageResult.dataList }" var="major">
					<tr>
						<td style="text-align: left; padding-left: 20px;"><input
							type="checkbox" name="ids" value="${major.majorId }" /></td>
