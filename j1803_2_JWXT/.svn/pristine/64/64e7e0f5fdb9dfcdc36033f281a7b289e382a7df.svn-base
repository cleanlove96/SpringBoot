...
<div class="panel teacher-panel">
  ...
  <center>
  		<table class="table"  height="300px">
      		...
      		<tr>
      			<td>
      				<label>姓名：</label>${teacher.tName }
      			</td>
      			<td>
      				<label>性别：</label>${teacher.sex }
      			</td>
      		</tr>
      		<tr>
      			<td>
      				<label>籍贯：</label>${teacher.nativePlace }
      			</td>
      			<td>
      				<label>年龄：</label>${teacher.age }
      			</td>
      		</tr>
      		<tr>
      			<td colspan="2">
      				<a href="<%=basePath %>personController/teaUpdateUI.do?tId=${teacher.tId}">修改信息</a>
      			</td>
      		</tr>
        </table>
  </center>
