	...
	<!--页眉-->
		...
		<div class="container">
			<ul class="nav navbar-nav navbar-left" style="float: left">
				<li class="col-xs-6 navHome"><a
					href="<%=basePath%>view/index.jsp"><span
						class="glyphicon glyphicon-home"> 首页</span></a></li>
				<li class="col-xs-6  navBackStage"><a
					href="<%=basePath%>view/login.jsp" style="text-decoration: none;">进入后台</a>
				</li>
			...
			<ul class="nav navbar-nav navbar-default navbar-right"
				style="float: right">
				<li>
					<a href="<%=basePath%>indexController/logout.do">注销</a>
				</li>
				<li>
		...
		<div id="ms-center" class="personal-member">
			<div class="cont">
				...
				<div class="main-wrap mt15" style="width: 85%;height: 500px">
					<strong><span class="icon-pencil-square-o"></span>我的课表</strong>
					<div class="body-content" align="center">
						<table border="1px solid gray" width="90%" height="200px;">
							...
							<tr class="first">
								...
								<th width="11%" style="text-align: center;">星期一</th>
								<th width="11%" style="text-align: center;">星期二</th>
								<th width="11%" style="text-align: center;">星期三</th>
								<th width="11%" style="text-align: center;">星期四</th>
								<th width="11%" style="text-align: center;">星期五</th>
								<th width="11%" style="text-align: center;">星期六</th>
								<th width="11%" style="text-align: center;">星期日</th>
							</tr>
							<tr height="50px"
								style="vertical-align: middle; text-align: center">
								<th style="line-height: 100px;text-align: center;">上午</th>
							...
							<tr height="50px"
								style="vertical-align: middle; text-align: center">
								<th style="line-height: 100px;text-align: center;">下午</th>
