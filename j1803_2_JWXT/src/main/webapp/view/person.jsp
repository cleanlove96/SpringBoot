...
<link rel="stylesheet" href="<%=basePath%>css/safe/personal_member.min.css" />
...
<body onload="qw()">
	...
	<!--界面主体-->
	<div class="container" style="background-color:#F8F8F8;padding: 10px;">
		<div id="ms-center" class="personal-member">
			<div class="cont">
				...
				<div class="main-wrap mt15" style="width: 85%">
					<strong><span class="icon-pencil-square-o"></span>个人信息</strong>
					<table class="table" style="height: 300px">
						<tr>
							<td colspan="2"><label>角色：</label>${role.roleName}</td>
						</tr>
						<tr>
							<td><label>姓名：</label>${student.sName }</td>
							<td><label>性别：</label>${student.sex }</td>
						</tr>
						<tr>
							<td><label>籍贯：</label>${student.nativePlace }</td>
							<td><label>年龄：</label>${student.age }</td>
						</tr>
					</table>
				</div>
			</div>
						...
						<div class="ad-info">
							<div class="sub-brands">
								<span>旗下子品牌</span> <a href="http://www.embedu.com/?sogou"
									...
									target="_blank">移动互联网学院</a> <a
									href="http://iot.hqyj.com/?sogou" target="_blank">物联网学院</a> <a
