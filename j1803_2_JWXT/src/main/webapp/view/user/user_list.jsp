...
<script type="text/javascript"
	src="<%=basePath%>view/user/searchLike.js"></script>
</head>
<body onload="load()">
	<form method="post" action="<%=basePath%>userController/deleteMany.do"
		id="fm">
			...
			<div class="padding border-bottom">
				<ul class="search">
					<li>
						...
						type="text" placeholder="请输入登录名" name="str" class="input"
				...
				<c:forEach items="${pageResult.dataList }" var="user">
					<tr>
						<td style="text-align: left; padding-left: 20px;"><input
							type="checkbox" name="ids" value="${user.userId }" /></td>
