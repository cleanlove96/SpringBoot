		...
		<div class="container">
			<ul class="nav navbar-nav navbar-left" style="float: left">
				<li class="col-xs-6 navHome"><a
					href="<%=basePath%>view/index.jsp">首页</a></li>
				<li class="col-xs-6  navHome"><a
					href="<%=basePath%>view/login.jsp" style="width:100px">进入后台</a>
				</li>
				...
				<div class="main-wrap mt15" style="width: 85%;">
						<div class="panel admin-panel">
						  ...
						  <div class="body-content">
						    ...
						    <form method="post" class="form-x center" action="<%=basePath%>indexController/pwdUpdate.do">  
