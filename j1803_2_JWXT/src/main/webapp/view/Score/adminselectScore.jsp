...
<script type="text/javascript"
	src="<%=basePath%>view/Score/listPageadmin.js"></script>
<script type="text/javascript">
$(document).ready(function(){ 
	  $("#button1").click(function(){  
        $("#form1").attr("action","<%=basePath%>scoreController/adminselectStudentScore.do");   
        $("#form1").submit();  
    });  
  $("#button2").click(function(){  
      $("#form1").attr("action","<%=basePath%>scoreController/adminselectSubjectScore.do");   
      $("#form1").submit();  
  });  
  $("#button3").click(function(){  
      $("#form1").attr("action","<%=basePath%>scoreController/adminselectAllScoreGroup.do");   
      $("#form1").submit();  
  });  
});
			...
			<div class="padding border-bottom">
				<ul class="search">
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" name="namestr" />
							<div class="tips"></div>
							<button class="button bg-main icon-check-square-o" type="submit"
								id="button1">查询</button>
						</div>
						<div class="label">
							<label><strong>按姓科目精确查询：</strong></label>
						</div>
						<div class="field">
							<input type="text" class="input w50" name="subjectstr" />
							<div class="tips"></div>
							<button class="button bg-main icon-check-square-o" type="submit"
								id="button2">查询</button>
							<button class="button bg-main icon-check-square-o" id="button3">
								排序</button>
							<button class="button bg-main icon-check-square-o" type="button" onclick="doPrint()">打印</button> 
						</div>
					</div>
				</ul>
