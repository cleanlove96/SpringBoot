...
<script type="text/javascript"
	src="<%=basePath%>view/Score/listPage2.js"></script>
<script type="text/javascript">
        function load() {
...
$(document).ready(function(){ 
	  $("#button1").click(function(){  
        $("#form1").attr("action","<%=basePath%>scoreController/StudentQueryScorelistPagegroup.do");   
        $("#form1").submit();  
    });  
  $("#button2").click(function(){  
      $("#form1").attr("action","<%=basePath%>scoreController/studentselectBysbujectName.do");   
      $("#form1").submit();  
  });  
});
				...
				<ul class="search">
					<div class="form-group">
						...
						<div class="field">
							...
							<button class="button bg-main icon-check-square-o" id="button1">排序</button>
						</div>
					</div>
					</li>
