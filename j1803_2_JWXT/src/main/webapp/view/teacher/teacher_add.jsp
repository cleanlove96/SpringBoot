...
<body>
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form method="post" class="form-x" action="<%=basePath%>teacherController/add.do">
			<div class="form-group" style="display: none;">
					<div class="label">
						<label>老师Id：</label>
					</div>
					<div class="field">
						<input type="text" class="input w50" value="${userId }" name="tId"
							readonly="true" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="tName"
							data-validate="required:请输入老师姓名" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
